...
import com.fr.swift.cloud.jdbc.adaptor.SelectionBeanParser;
...
import com.fr.swift.cloud.jdbc.visitor.select.GroupByVisitor;
import com.fr.swift.cloud.jdbc.visitor.select.NoGroupByVisitor;
import com.fr.swift.cloud.jdbc.visitor.select.OrderByVisitor;
import com.fr.swift.cloud.jdbc.visitor.where.BoolExprVisitor;
...
import com.fr.swift.cloud.query.info.bean.element.filter.impl.ComplexFilterInfoBean;
